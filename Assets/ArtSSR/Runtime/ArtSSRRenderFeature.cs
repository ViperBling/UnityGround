...
namespace ArtSSR
{
    public partial class ArtSSRRenderFeature : ScriptableRendererFeature
    {
        ...
        {
            if (m_SSRSettings.m_SSRMaterial != null) return true;

            if (m_SSRSettings.m_SSRShader == null)
            {
                m_SSRSettings.m_SSRShader = Shader.Find("Hidden/ArtSSRShader");
                if (m_SSRSettings.m_SSRShader == null)
                {
            ...
            m_SSRSettings.m_SSRMaterial = CoreUtils.CreateEngineMaterial(m_SSRSettings.m_SSRShader);
            
            return m_SSRSettings.m_SSRMaterial != null;
        }
