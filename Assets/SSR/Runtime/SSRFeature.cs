...
namespace SSR
{
    ...
    public partial class SSRFeature : ScriptableRendererFeature
    {
        ...
        private ScreenSpaceReflectionPass m_SSRRenderPass;
        ...
        public override void Create()
        {
            ...
            {
                m_SSRRenderPass = new ScreenSpaceReflectionPass(m_SSRMaterial);
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            ScreenSpaceReflectionEffect artSSRVolume = stack.GetComponent<ScreenSpaceReflectionEffect>();
        ...
        private void GetMaterial()
        {
            ...
            if (m_SSRShader == null)
            {
                m_SSRShader = Shader.Find("Hidden/SSRShader");
                if (m_SSRShader == null)
                {
